...
<div id="head">
    <div class="logo_title">
        ...
        <p style="color: red">${requestScope.updatePictureMsg}</p>
    </div>
    <div class="navi">
        <ul>
    ...
    <div class="col" >
            <div class="col-sm-2 col-md-3 "  >
                ...
                <table class="table table-bordered">
                    <tr class="warning">
                        <td>
                            <h4 class="center-block">${requestScope.title}</h4>
                        </td>
                    </tr>
                    <tr class="success">
                        <td>
...
<form role="form" method="post" class="container" action="http://localhost:8080/nw/UserRoleServlet">
    <div class="form-group container">
        ...
        <input type="hidden" name="main" value="${requestScope.main}">
        <input type="hidden" name="title" value="${requestScope.title}">
        <input type="hidden" name="zoom" value="${requestScope.zoom}">
    </div>
</form>
<form role="form" method="post" class="container" action="http://localhost:8080/nw/UserRoleServlet">
    <div class="form-group " >
        ...
        <input type="hidden" name="username" value="${requestScope.username}">
        <input type="hidden" name="password" value="${requestScope.password}">
        <input type="hidden" name="oldMain" value="${requestScope.main}">
        <input type="hidden" name="title" value="${requestScope.title}">
        <input type="hidden" name="zoom" value="${requestScope.zoom}">
    </div>
</form>
...
<form action="FileUpLoadServlet" method="post" enctype="multipart/form-data" class="container" role="form">
    <input type="hidden" name="id" value="${requestScope.id}">
    <input type="hidden" name="username" value="${requestScope.username}">
    <input type="hidden" name="password" value="${requestScope.password}">
    <input type="hidden" name="oldMain" value="${requestScope.main}">
