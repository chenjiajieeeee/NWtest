...
public class ManagerServiceImpl implements ManagerService{
    ...
    public boolean login(String account, String password) {
        ...
        return managerDao.managerLogin(account, password);
    }

    @Override
    public String searchZoom(String account) {
        ManagerDao managerDao=new ManagerDaoImpl();
        return managerDao.searchZoomByAccount(account);
    }

    @Override
    public List<Note> queryNoteByArea(String zoomName) {
        ManagerDao managerDao=new ManagerDaoImpl();
        return managerDao.queryNoteByArea(zoomName);
    }
